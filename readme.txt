...
Example => <?php echo the_qf_get_thumb_one('num=0&width=120&tag=1&global=1&crop_w=120&crop_h=120', './images/defaultimg.png'); ?>
...
* fix way to compare the object types and loop syntax.

= 1.2.10 =

* fix way to initialize array.

= 1.2.9 =
* explode function instead of split function.
...
* Other website images support. update by 2 weeks, show website is displaying very slowly  when updating. set option 'global=1'. Example: <?php echo the_qf_get_thumb_one('num=0&width=160&tag=1&crop_w=160&crop_h=120&global=1', './images/defaultimg.png', 'http://www.yahoo.co.jp'); ?>
